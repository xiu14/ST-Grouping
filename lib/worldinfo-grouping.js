...
async function refreshGroupedView() {
    ...
    try {
        ...
        const renderedUngroupedEntries = entriesList.children('.world_entry');
        const renderedUngroupedCount = renderedUngroupedEntries.length;
        const expectedUngroupedCount = ungroupedUids.length;
        const hasUngroupedMismatch = renderedUngroupedCount !== expectedUngroupedCount;
        const ungroupedCountText = hasUngroupedMismatch
